          ...
          <div className="bs-stepper-content">
            <form onSubmit={this.onSubmit}>
              ...
              <div id="test-l-2" className="content">
                ...
                <div>
                  <button type="submit" className="btn btn-green mt-5">Ajustar</button>
                  <button type="submit" className="btn btn-green mt-5">Observar</button>
                </div>
                <div>
                  <button type="submit" className="btn btn-gray mt-5">Ajustar a cargo</button>
                  <button type="submit" className="btn btn-gray mt-5">Rechazar</button>
                </div>
              </div>
